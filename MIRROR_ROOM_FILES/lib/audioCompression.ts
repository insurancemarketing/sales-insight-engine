...
// Audio chunking and compression for large files (up to 100MB)
// Downsamples to 16kHz mono WAV and splits into ~4MB chunks

const DEFAULT_SAMPLE_RATE = 16000;
const DEFAULT_TARGET_BYTES = 4 * 1024 * 1024; // 4MB to avoid edge function memory limits
