            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {analysis.key_strengths.map((strength, i) => (
                  <div key={i} className="p-4 rounded-lg bg-green-500/5 border border-green-500/10">
                    <p className="font-medium text-sm text-green-500 mb-1">{strength.technique}</p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {analysis.areas_for_improvement.map((area, i) => (
                  <div key={i} className="p-4 rounded-lg bg-yellow-500/5 border border-yellow-500/10">
                    <p className="font-medium text-sm text-yellow-500 mb-1">{area.technique}</p>
                ...
                {analysis.cialdini_principles.map((principle, i) => (
                  <div key={i} className="p-4 rounded-lg border bg-card">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      {principle.used ? (
                        <Badge className="bg-green-500/10 text-green-500 border-0">Used</Badge>
                      ) : (
                  ...
                  {analysis.client_objections.map((obj, i) => (
                    <div key={i} className="p-4 rounded-lg border">
                      <div className="flex items-start justify-between mb-2">
                        ...
                        {obj.handled ? (
                          <Badge className="bg-green-500/10 text-green-500 border-0">Handled</Badge>
                        ) : (
                      ...
                      <div className="grid sm:grid-cols-2 gap-4 text-sm">
                        ...
                        <div className="bg-green-500/5 p-3 rounded-lg">
                          <p className="text-green-500 mb-1 font-medium">Better Response:</p>
