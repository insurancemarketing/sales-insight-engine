...
import { X, Loader2, CheckCircle, AlertCircle, FileAudio } from 'lucide-react';
...
function JobCard({ job }: { job: TranscriptionJob }) {
  ...
  return (
    <div className="bg-card border rounded-lg shadow-lg p-4 w-80 animate-fade-in">
