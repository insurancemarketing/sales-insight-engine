...
export default function CallHistory() {
  ...
  const getStatusBadge = (status: string, outcome?: string) => {
    if (status === 'completed' && outcome) {
      if (outcome === 'won') {
        return <Badge className="bg-success/10 text-success border-0">Won</Badge>;
      }
      return <Badge className="bg-destructive/10 text-destructive border-0">Lost</Badge>;
    }
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              className={filter === 'won' ? 'bg-success hover:bg-success/90' : ''}
            >
              Won
            </Button>
            <Button
              ...
              className={filter === 'lost' ? 'bg-destructive hover:bg-destructive/90' : ''}
            >
              Lost
            </Button>
          </div>
